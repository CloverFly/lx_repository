...
// JFFileManager
#define COCOAPODS_POD_AVAILABLE_JFFileManager
#define COCOAPODS_VERSION_MAJOR_JFFileManager 1
#define COCOAPODS_VERSION_MINOR_JFFileManager 0
#define COCOAPODS_VERSION_PATCH_JFFileManager 2
